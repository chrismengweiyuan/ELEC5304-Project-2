...
from custom_model import DnCNN
# ============================================
...
if __name__ == '__main__':
    ...
    # create a DnCNN object with depth = 9
    model = DnCNN(depth=9)
    if cuda:
        model = model.cuda()
    model.train()
    ...
    # the scheduler is arranged with 3 milestone points at 10, 14, 17 for better loss convergence
    # the decay factor is set to 0.5
    scheduler = MultiStepLR(optimizer, milestones=[10, 14, 17], gamma=0.5)  # learning rates
